package com.yumodev.airthmetic.sort;
...
public class Sort {
     ...
     * 2015-1-5
     */
    public void bubbleSort(int ran[]) {

        System.out.println("排序前打印数据：");
        for (int n = 0; n < ran.length; n++) {
            System.out.print(ran[n] + " ");
        }
