package com.yumodev.thread.threadpattern.producer_consumer;
...
public class MakerEaterArrayBlocking {
    ...
    public static void main(String[] args){
        ...
        new MakeThread("MakeThread-1", table, 100000).start();
        new MakeThread("MakeThread-2", table, 100000).start();
        new MakeThread("MakeThread-3", table, 100000).start();
        new EaterThread("Eaterhread-1", table, 100000).start();
        new EaterThread("Eaterhread-2", table, 100000).start();
        new EaterThread("Eaterhread-3", table, 100000).start();
    }
}
